...
if __name__ == "__main__":
    ...
    if is_debug:
        ...
        writer = SummaryWriter('/home/dengfy/resnet1d-master/train_log/'+sid)
    ...
    for _ in tqdm(range(n_epoch), desc="epoch", leave=False):
        ...
        writer.add_scalar('Loss/train', loss_e, _)
        ...
        loss_e = np.mean(loss_list)
        writer.add_scalar('Loss/test', loss_e, _)
        ...
        acc = accuracy_score(Y_test, all_pred_test)
        cm = confusion_matrix(Y_test, all_pred_test)
        if acc > best_acc:
            best_acc = acc
